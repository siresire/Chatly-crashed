...
import { DotsThreeCircleVertical, DownloadSimple, Image, DotsThreeVertical } from 'phosphor-react';
import { Message_options } from "../../data"

const DocMsg = (el,menu) => {
    const theme = useTheme();
    return (
        <Stack direction={el.incoming ? 'start' : 'end'} justifyContent="flex-start">
            <Box
                p={1.5}
                sx={{
            ...
            >
                ...
                <Stack spacing={2}>
                    <Stack p={2} spacing={3} alignItems={"center"} sx={{ backgroundColor: theme.palette.background.paper, borderRadius: 1 }}>
                        ...
                        <Stack spacing={2}>
                            <Typography variant='subtitle2'>Creatinf chat app </Typography>
...
// To come back on part 4 minute 30
        ...
        <Stack direction={el.incoming ? 'start' : 'end'} justifyContent="flex-start">
            ...
            >
                <Stack spacing={1}>
                    ...
                    />
                    {/* <Typography variant='body2' color={el.incoming ? 'text.primary' : '#fff'}>
                        {el.message}
                    </Typography> */}
    ...
    return (
        <Stack direction={"row"} justifyContent={el.incoming ? "start" : "end"}>
            ...
            >
                <Typography
                    variant='body2'
                    color={el.incoming ? 'text.primary' : '#fff'}
                >
                    {el.message}
                </Typography>
            </Box>
...
const Timeline = ({ el }) => {
    ...
    const theme = useTheme();
    return (
        <Stack direction="row" alignment="center" justifyContent="space-between">
